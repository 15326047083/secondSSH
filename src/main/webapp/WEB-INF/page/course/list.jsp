...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    ...
    <tr>
        <td align="left" valign="top" class="fenye"> <s:property value="#index"/>/<s:property value="#allPage"/>页&nbsp;&nbsp;
            <a href="<%=request.getContextPath()%>queryCourse.action?index=1" target="mainFrame" onFocus="this.blur()">首页</a>&nbsp;&nbsp;
            ...
            <s:if test="#index>1">
                <a id="prior"
                   href="<%=request.getContextPath()%>queryCourse.action?index=<s:property value="#index-1"/>" target="mainFrame" onFocus="this.blur()">上一页</a>&nbsp;&nbsp;
            </s:if>
            <s:if test="#allPage>#index">
                <a id="last" href="<%=request.getContextPath()%>queryCourse.action?index=<s:property value="#index+1"/>" target="mainFrame" onFocus="this.blur()">下一页</a>&nbsp;&nbsp;
            </s:if>
            <s:if test="#allPage<=#index">
            ...
            <a
                    href="<%=request.getContextPath()%>queryCourse.action?index=<s:property value="#allPage"/>" target="mainFrame" onFocus="this.blur()">尾页</a></td>
    </tr>
