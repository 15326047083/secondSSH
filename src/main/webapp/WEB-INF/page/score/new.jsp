...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
    <tr>
        <td width="99%" align="left" valign="top">您的位置：成绩管理&nbsp;&nbsp;>&nbsp;&nbsp;添加成绩</td>
    </tr>
    <tr>
        <td align="left" valign="top">
            <form method="post" action="<%=request.getContextPath()%>saveScore.action">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <select name="score.userId" id="level1">
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <select name="score.courseId" id="level">
                                <s:iterator var="course" value="courseList">
                                    <option value="<s:property value="#course.id"/>"><s:property
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" name="score.score" value="" class="text-word" required>
                        </td>
                    </tr>
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" name="score.info" value="" class="text-word" required>
                        </td>
                    </tr>
