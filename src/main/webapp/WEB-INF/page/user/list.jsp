...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
                ...
                <s:iterator var="queryUser" value="queryAllList" status="queryAllList">
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.name"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.num"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.phone"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.email"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.sex"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.edu"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.joinTime"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                                value="#queryUser.deptId"/></td>
                        <td align="center" valign="middle" class="borderright borderbottom"><s:property
                        ...
                        <td align="center" valign="middle" class="borderbottom">
                            ...
                            <a href="/user/updateAlive.action?userId=<s:property value="#queryUser.id"/>"
    ...
    <tr>
        <td align="left" valign="top" class="fenye"><s:property value="#index"/>/<s:property value="#allPage"/>页
            ...
            <s:if test="#index>1">
                <a href="queryAll.action?index=<s:property value="index-1"/>">上一页</a>
            </s:if>
            ...
            <s:if test="#allPage>#index">
                <a href="queryAll.action?index=<s:property value="index+1"/>">下一页</a>
            </s:if>

            <a href="<%=request.getContextPath()%>queryAll.action?index=<s:property value="#allPage"/>"
