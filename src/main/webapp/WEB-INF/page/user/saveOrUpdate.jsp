        ...
        <td align="left" valign="top">
            <form method="post" action="<%=request.getContextPath()%>update.action">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
                    <input type="hidden" name="user.id" value="<s:property value="#userInfo.id"/>"
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" name="user.name" value="<s:property value="#userInfo.name"/>"
                                   class="text-word" required>
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for"><s:property
                                value="userInfo.num"/>
                            <input type="text" name="user.num" value="<s:property value="#userInfo.num"/>"
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" name="user.phone" value="<s:property value="#userInfo.phone"/>"
                                   class="text-word" required>
                        </td>
                    </tr>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                    ...
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        ...
                        <td align="left" valign="middle" class="borderright borderbottom main-for">
                            <input type="text" name="user.joinTime" value="<s:property value="#userInfo.joinTime"/>"
                                   class="text-word" readonly>
                        </td>
                    </tr>
                    <shiro:hasRole name="admin">
                        <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                            ...
                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                <input type="text" name="user.edu" value="<s:property value="#userInfo.edu"/>"
                                       class="text-word" required>
                            </td>
                        </tr>
                        <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                            ...
                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                <input type="text" name="user.deptId" value="<s:property value="#userInfo.deptId"/>"
                                       class="text-word" required>
                            </td>
                        </tr>
                        <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                            ...
                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                <input type="text" name="user.duty" value="<s:property value="#userInfo.duty"/>"
                                       class="text-word" required>
                            </td>
                        </tr>
                        <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                            ...
                            <td align="left" valign="middle" class="borderright borderbottom main-for">
                                <input type="text" name="user.userType" value="<s:property value="#userInfo.userType"/>"
                                       class="text-word" required>
                            </td>
                        </tr>
                    </shiro:hasRole>
                    <input type="hidden" name="user.alive" value="<s:property value="#userInfo.alive"/>"
                           class="text-word" required>
                    <shiro:lacksRole name="admin">
                        <input type="hidden" name="user.edu" value="<s:property value="#userInfo.edu"/>"
                               class="text-word" required>
                        <input type="hidden" name="user.deptId" value="<s:property value="#userInfo.deptId"/>"
                               class="text-word" required>
                        <input type="hidden" name="user.duty" value="<s:property value="#userInfo.duty"/>"
                               class="text-word" required>
                        <input type="hidden" name="user.userType" value="<s:property value="#userInfo.userType"/>"
                               class="text-word" required>
                    </shiro:lacksRole>
                    <tr onMouseOut="this.style.backgroundColor='#ffffff'"
                        onMouseOver="this.style.backgroundColor='#edf5ff'">
