...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="footer">
  <tr>
    ...
    <td align="right" valign="middle" class="footer_pad"><img src="/css/images/main/why.gif" width="12" height="12" alt="疑问图标" align="absmiddle">&nbsp;&nbsp;如有疑问请您联系TEL：010-88312038-8015</td>
  </tr>
</table>
</body>
</html>