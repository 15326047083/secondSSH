...
<head>
    ...
    <style>
        ...
        #main div.top {
            width: 100%;
            background: url(/css/images/main/main_r2_c2.jpg) no-repeat 0 10px;
            padding: 0 0 0 15px;
            line-height: 35px;
            float: left
        }
        ...
        #main div.sec {
            width: 100%;
            background: url(/css/images/main/main_r2_c2.jpg) no-repeat 0 15px;
            padding: 0 0 0 15px;
            line-height: 35px;
            float: left
        }
        ...
        div.main-tit {
            ...
            font-weight: bold;
            color: #4e4e4e;
            background: url(/css/images/main/main_r4_c2.jpg) no-repeat 0 33px;
            width: 100%;
        ...
        div.main-corpy {
            ...
            font-weight: bold;
            color: #4e4e4e;
            background: url(/css/images/main/main_r6_c2.jpg) no-repeat 0 33px;
            width: 100%;
            padding: 30px 0 0 20px;
            float: left
        }
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="main">
    <tr>
        <td colspan="2" align="left" valign="top">
            <span class="time"><strong>上午好！<%=user.getName()%></strong>
                <u>
                    <shiro:hasRole name="user">【学员】</shiro:hasRole>
                    <shiro:hasRole name="admin">【超级管理员】</shiro:hasRole>
                    <shiro:hasRole name="teacher">【老师】</shiro:hasRole>
                </u>
            </span>
        </td>
    </tr>
